...
MapBuilder::MapBuilder(int width, int height, double resolution, double init_x, double init_y) :
  ...
  has_frame_id_(false)
{
  ...
  map_.info.origin.position.x+=init_x;
  map_.info.origin.position.y+=init_y;
