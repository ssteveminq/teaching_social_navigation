...
inline real_s DEG2RAD(int d)	 { return (d * SR_RADIAN); }
inline real_s RAD2DEG(int r)	 { return (r * SR_DEGREE); }
inline real_s DEG2RAD(float d) { return (d * SR_RADIAN); }
inline real_s RAD2DEG(float r) { return (r * SR_DEGREE); }
inline real_s DEG2RAD(double d){ return (d * SR_RADIAN); }
inline real_s RAD2DEG(double r){ return (r * SR_DEGREE); }
